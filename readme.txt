=== HappyFox Helpdesk ===
Contributors: Agent.Logic_, vijaytenmiles
...
2. Search for 'HappyFox Helpdesk for WordPress'
3. Click 'Install Now' and activate the plugin

For a manual installation:

1. Download the latest version of ‘HappyFox Helpdesk for Wordpress\' plugin from the WordPress Plugin Directory.
